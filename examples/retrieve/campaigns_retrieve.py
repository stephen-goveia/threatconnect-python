...
def show_data(result_obj):
    ...
    for obj in result_obj:
        ...
        #
        # resource associations (campaign)
        #
        i_header = True
        for i_associations in obj.indicator_associations:
            ...
            print('{0!s:<20}{1!s:<50}'.format('  Indicator', i_associations))
...
def main():
    ...
    if enable_example1:
        """ This is a basic example that pull all campaigns for the default org. """
    ...
    if enable_example3:
        """ This example adds a filter to pull an campaign by id. """
        # optionally set max results
        tc.set_api_result_limit(500)
    ...
    if enable_example4:
        """ This example adds a filter with multiple sub filters.  This request
            will return any campaigns that matches any filters. """
        ...
        try:
            ...
            filter1.add_incident_id(921849)
    ...
    if enable_example5:
        """ This example adds multiple filters to limit the result set.  This request
            will return only campaigns that match all filters. """
