...
def show_data(result_obj):
    ...
    for obj in result_obj:
        ...
        if isinstance(obj.indicator, dict):
            ...
            print('{0:<20}{1:<50}'.format('Indicator', obj.indicator))
        ...
        print('{0:<20}{1:<50}'.format('Last Modified', obj.last_modified))
        print('{0:<20}{1:<50}'.format('Rating', obj.rating))
        print('{0:<20}{1:<50}'.format('TA Rating', obj.threat_assess_rating))
        print('{0:<20}{1:<50}'.format('Confidence', obj.confidence))
        print('{0:<20}{1:<50}'.format('TA Confidence', obj.threat_assess_confidence))
        ...
        if obj.resource_type == ResourceType.FILES:
            ...
            if len(obj.file_occurrences) > 0:
                print('\n{0:-^40}'.format(' File Occurrence '))
                for fo_obj in obj.file_occurrences:
                    print('{0:<20}{1:<50}'.format('  File Name', fo_obj.file_name))
                    print('{0:<20}{1:<50}'.format('  Path', fo_obj.path))
        ...
        if obj.resource_type == ResourceType.HOSTS:
            ...
            if len(obj.dns_resolutions) > 0:
                print('\n{0:-^40}'.format(' DNS Resolutions '))
                for dr_obj in obj.dns_resolutions:
                    print('{0:<20}{1:<50}'.format('  IP', dr_obj.ip))
                    print('{0:<20}{1:<50}'.format('  Owner', dr_obj.owner_name))
                    print('{0:<20}{1:<50}'.format('  Resolution Date', dr_obj.resolution_date))
