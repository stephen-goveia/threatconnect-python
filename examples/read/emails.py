...
def show_data(result_obj):
    ...
    if result_obj.get_status().name == "SUCCESS":
        for obj in result_obj:
            ...
            # print('{:<20}{:<50}'.format('Subject', obj.get_subject()))
            # print('{:<20}{:<50}'.format('From', obj.get_from()))
            # print('{:<20}{:<50}'.format('To', obj.get_to()))
            # print('{:<20}{:<50}'.format('Body', obj.get_body()))
            # print('{:<20}{:<50}'.format('Score', obj.get_score()))
            # print('{:<20}{:<50}'.format('Header', obj.get_header()))
