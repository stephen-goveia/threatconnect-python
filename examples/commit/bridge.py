...
#
# retrieve source configuration file (retrieve instance of ThreatConnect)
#
...
try:
    ...
    src_api_result_limit = src_config.get('threatconnect', 'api_result_limit')
except ConfigParser.NoOptionError:
    print('Could not retrieve source configuration file.')
    sys.exit(1)

src_tc = ThreatConnect(
    src_api_access_id, src_api_secret_key, src_api_default_org, src_api_base_url, src_api_result_limit)
src_owners = ['Common Community']

#
# retrieve destination configuration file (commit instance of ThreatConnect)
#
...
try:
    ...
    dst_api_result_limit = dst_config.get('threatconnect', 'api_result_limit')
except ConfigParser.NoOptionError:
    print('Could not retrieve source configuration file.')
    sys.exit(1)
...
def main():
    ...
    src_tc.set_api_result_limit(500)
    ...
    if src_indicators.status.name == "SUCCESS":
