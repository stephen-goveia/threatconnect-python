...
# - These campaigns must be created before running this script
#
owner = 'Example Community'  # org or community
lu_id = 5770  # campaign id for loop update
mu_id = 5771  # campaign id for manual update
# dl_id = 999999  # campaign id to delete
email_id = 2157  # email resource id to associate with campaign
victim_id = 2  # victim resource id to associate with campaign
ip_address = '10.20.30.40'  # ip address to associate to campaign
...
def main():
    ...
    for res in resources:
        ...
        if res.id == lu_id:
            ...
            #
            res.set_name('LU campaign #{0:d}'.format(rn))
    ...
    resource = resources.add('MU campaign #{0:d}'.format(rn), owner)  # this will overwrite exising resource name
