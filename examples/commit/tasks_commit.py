...
def main():
    ...
    for res in resources:
        ...
        if res.id == lu_id:
            ...
            #
            res.set_name('LU Tasks #{0:d}'.format(rn))
    ...
    resource = resources.add('DELETE #{0:d}'.format(rn))
    
    resource.set_due_date('2016-03-{0:d}T00:00:00'.format(randint(1, 10)))
    resource.set_due_date('2016-05-04T13:06:00Z')
    resource.set_escalation_date('2016-03-{0:d}T00:00:00'.format(randint(20, 30)))
    resource.set_escalation_date('2016-06-04T13:06:00Z')
    resource.set_reminder_date('2016-03-{0:d}T00:00:00'.format(randint(10, 20)))
    resource.set_reminder_date('2016-05-14T13:06:00Z')
    resource.set_escalated('false')
    resource.set_overdue('false')
    ...
    resource = resources.add('MU Task #{0:d}'.format(rn))  # this will overwrite exising resource name
